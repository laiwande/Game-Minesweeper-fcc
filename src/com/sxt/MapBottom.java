    ...
    void paintSelf(Graphics g) {
        ...
        switch (GameUtil.state){
            ...
            case 1:
                ...
                GameUtil.drawWord(g,"有点东西",GameUtil.OFFSET+(GameUtil.Map_W-2)*GameUtil.SQUARE_LENGTH-10,3*GameUtil.OFFSET+GameUtil.Map_H*GameUtil.SQUARE_LENGTH+20,20,Color.RED);
                break;
            case 2:
                g.drawImage(
                        GameUtil.over,
